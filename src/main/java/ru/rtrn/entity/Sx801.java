...
public class Sx801 extends Device{
    ...
    public void initParams() {
        ...
        params.add(new Param("Current forward power", ".1.3.6.1.4.1.2566.127.1.2.167.201.1.2.1.13.1", "The measured forwarded power [W].."));
        params.add(new Param("Current reflected power", ".1.3.6.1.4.1.2566.127.1.2.167.201.1.2.1.14.1", "The measured reflected power [W]."));
        params.add(new Param("Output power", ".1.3.6.1.4.1.2566.127.1.2.167.212.1.5.1.99.1.1", "Amplifier output power 0 ... 400 W."));
        params.add(new Param("Output RF", ".1.3.6.1.4.1.2566.127.1.2.167.212.1.5.1.70.1.1", "Turns on/switches off the output signal.\n" +
